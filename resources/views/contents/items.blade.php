...
<div class="cube-full-width">
            <div id="filters-container" class="cbp-l-filters-alignCenter">
                ...
                <div data-filter=".coats" class="cbp-filter-item">
                    Coats <div class="cbp-filter-counter"></div>
                </div> /
            ...
            <div id="fullwidth-container" class="cbp">
                <div class="cbp-item coats logos">
                    <a href="{{ asset('imgs/products/coats/G1-15CH12-50-1BC(1).jpg')}}" class="cbp-caption cbp-lightbox" data-title="Dashboard<br>by Paul Flavius Nechita">
                        <div id="cf">
                ...
                <div class="cbp-item coats motion">
